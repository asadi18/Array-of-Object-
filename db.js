...
// users.map(function ({ userId, id, title, completed }, index) {
...
//   // return (`index:${index}, userId:${userId},id:${id},title:${title},completed:${completed}`)

//   // console.log(`index:${index}, userId:${userId},id:${id},title:${title},completed:${completed}`)
// });
